...
export default function LobbyPage() {
  ...
  const joinQueue = () => {
    if (!selectedFee) {
      toast.error('Select an entry fee first');
      return;
    }
                ...
                style={{
                  ...
                  background:
                    selectedCategory === cat.id
                      ...
                      : '#111118',
                  border: `1px solid ${
                    selectedCategory === cat.id ? '#7c3aed' : '#2a2a3a'
                  }`,
                  color:
                    selectedCategory === cat.id
                      ? '#8b5cf6'
            ...
            return (
              <motion.div
                ...
                style={{
                  background: selected
                    ...
                    : '#111118',
                  border: `1px solid ${
                    selected ? '#7c3aed' : '#2a2a3a'
                  }`,
                  borderRadius: '12px',
                  padding: '20px',
                  cursor:
                    inQueue || locked ? 'not-allowed' : 'pointer',
                  position: 'relative',
                  transition: 'all 0.15s',
              ...
              >
                ...
                >
                  ...
                  <Badge variant={difficultyVariant(tier.difficulty)}>
                    {tier.difficulty}
                  </Badge>
                </div>
