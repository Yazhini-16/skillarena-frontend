...
const features = [
  {
    ...
    desc: 'Solve actual algorithmic problems. Skill decides the winner, nothing else.',
  },
  {
    icon: <Clock size={22} />,
    title: 'Live 1v1 battles',
    desc: 'Matched in seconds. Same problem, same clock. First to solve wins.',
  },
  {
    icon: <Shield size={22} />,
    title: 'Secure & fair',
    desc: 'Server-authoritative judging. Every submission verified against hidden test cases.',
  },
  {
    icon: <Trophy size={22} />,
    title: 'Real prizes',
    desc: 'Win up to 1.8× your entry. Platform takes only 10%. You keep the rest.',
  },
];
    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0f' }}>
      ...
      >
        ...
        >
          ...
          >
            Compete in real-time coding duels. Pay an entry fee, solve the
            problem faster than your opponent, and walk away with the prize.
          </p>
            ...
            {[
              {
                ...
                desc: 'Deposit any amount. Funds are held securely until your match resolves.',
              },
              {
                step: '02',
                title: 'Pick your entry fee',
                desc: 'Choose from ₹10 to ₹500. Higher stakes = harder problems.',
              },
              {
                step: '03',
                title: 'Get matched instantly',
                desc: 'We find an opponent at the same tier in under 5 seconds.',
              },
              {
                step: '04',
                title: 'Solve the problem',
                desc: 'Same problem, same 30-minute clock. Code in JS, Python, C++, or Java.',
              },
              {
                step: '05',
                title: 'Winner gets paid',
                desc: 'Server validates both solutions. Faster correct solution wins the prize pool.',
              },
            ].map((item, i) => (
              <motion.div
                key={item.step}
